...
% ERP analysis
%
%   -> averging EEG singal for SVM and permutation test (exp7-1 target, 1 distractor, 1 neutral)
%
% created at 2019.06.05 PBY
...
%     EEG = eeg_checkset( EEG );
    ...
    for timepoint = 1:size(fornnstart_comb,3)
        ...
        % target list: remove other cues except target cues
         fornnstart2_target((fornnstart2_target(:,end-2)==2) | (fornnstart2_target(:,end-2)==3),:) = [];
...
%        fornnstart2_dist((fornnstart2_dist(:,end-2)==2) | (fornnstart2_dist(:,end-2)==3)  | (fornnstart2_dist(:,end-2)==4),:) = [];
        fornnstart2_dist((fornnstart2_dist(:,end-2)==1) | (fornnstart2_dist(:,end-2)==3),:) = [];
